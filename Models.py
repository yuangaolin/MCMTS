...
from static.constant import DrugAE_InputDim, DrugAE_OutputDim, CELLAE_InputDim, CellAE_OutputDim, MCMTSYN_InputDim
...
class MCMTSYN(Module):
    def __init__(self, hidden_neurons, input_dim=MCMTSYN_InputDim):
        super(MCMTSYN, self).__init__()
