...
drugs = pd.read_csv('autodl-tmp/MTL/data/drug_features.csv')
print("drugs.shape:", drugs.shape)
cell_lines = pd.read_csv('autodl-tmp/MTL/data/cell_line_features.csv')
print("cell_lines.shape:", cell_lines.shape)
summary = pd.read_csv('autodl-tmp/MTL/data/oneil_summary_idx.csv')
